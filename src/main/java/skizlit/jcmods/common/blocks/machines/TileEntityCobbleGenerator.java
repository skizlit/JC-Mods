...
public class TileEntityCobbleGenerator extends TileEntity implements ITickable {
	...
	{
		return this.hasCustomName() ? new TextComponentString(this.customName) : new TextComponentTranslation("container.CobbleGenerator");
	}
	...
	public static boolean isBurning(TileEntityCobbleGenerator te) 
	{
